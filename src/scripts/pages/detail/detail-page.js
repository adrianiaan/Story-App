...
export default class DetailPage {
  ...
  async afterRender() {
    ...
    storyContainer.innerHTML = '<div class="story__not-found">Memuat cerita...</div>';
    ...
    try {
      ...
      storyContainer.innerHTML = '<div class="story__not-found">Error: Tidak dapat memuat cerita</div>';
    }
  }
}